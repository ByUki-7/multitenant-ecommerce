...
const buttonVariants = cva(
  ...
  dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive border cursor-pointer`,
  {
    variants: {
      variant: {
        default:
        ...
        none: "",
        elevated: `bg-white hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[4px_4px_0px_0px_rgba(200,200,200,1)] hover:-translate-x-[4px]
